  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-2">
        <Card>
          ...
          <CardContent className="grid gap-4">
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel className="mt-3 text-lg font-semibold mb-2">Choose Icon</FormLabel>
                  <FormControl>
                    <div className="grid grid-cols-2 gap-2">
                      {IconOptions.map(option => (
                        <Button
                          key={option.id}
                          type="button"
                          variant={field.value === option.id ? "custom" : "outline"}
                          onClick={() => {
                ...
                <FormItem>
                  ...
                  <FormControl>
                    <MultipleSelector
                      ...
                      onChange={(options) => field.onChange(optionsToArray(options))}
        ...
        <SheetFooter>
          <SheetClose asChild>
            <Button type="button" variant="destructive" className="mr-auto">Cancel</Button>
          </SheetClose>
