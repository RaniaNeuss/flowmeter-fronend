...
import { Devices, SelectPolling, SelectType } from "@/types/connections";

import { toast } from "react-hot-toast";
import { Input } from "@/components/ui/input";
import { Textarea } from "@/components/ui/textarea";
import { Button } from "@/components/ui/button";
import WebAPIForm from "@/app/(dashboard)/Projects/[ProjectId]/connections/WebAPI";
import S7Form from "@/app/(dashboard)/Projects/[ProjectId]/connections/S7";
import DbForm from "@/app/(dashboard)/Projects/[ProjectId]/connections/DB";
                ...
                <div>
                  <div className="relative inline-grid h-10 grid-cols-[1fr_1fr] items-center text-sm font-medium">
                    <Switch
                      ...
                      className="peer absolute inset-0 h-[inherit] w-auto rounded-lg data-[state=unchecked]:bg-red-600 data-[state=checked]:bg-[rgba(72,195,137,1)] [&_span]:z-10 [&_span]:h-full [&_span]:w-1/2 [&_span]:rounded-md [&_span]:transition-transform [&_span]:duration-300 [&_span]:[transition-timing-function:cubic-bezier(0.16,1,0.3,1)] data-[state=checked]:[&_span]:translate-x-full rtl:data-[state=checked]:[&_span]:-translate-x-full"
                    />
