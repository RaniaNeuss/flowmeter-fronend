...
import AssignUser from "@/app/components/AssignUser/AssignUsers";
import { motion } from "framer-motion";
import { containerCampaignForm as container } from "@/constants/framer-motion";
import InviteUser from "@/app/components/Users/InviteUser";
  ...
  return (
    <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
      <DialogTrigger asChild>
        <Button variant="default">Assign/Add User for {projectName}</Button>
      </DialogTrigger>
