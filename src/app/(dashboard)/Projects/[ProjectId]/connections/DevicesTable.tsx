            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button className="ml-auto text-red-500" variant="outline">
                  ...
                  />
                  Delete
                  <span className="bg-background text-muted-foreground/70 -me-1 inline-flex h-5 max-h-full items-center rounded border px-1 font-[inherit] text-[0.625rem] font-medium text-red-500">
